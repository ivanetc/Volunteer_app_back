...
@WebServlet(name = "GetUserStatusServlet", urlPatterns = { "api/user/getUserStatus" })
public class GetUserStatusServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request,
        ...
        if (authToken != null && authToken.equals(ServerStarter.token()))
            responceString = getUserStatusJson();
        else
    ...
    private String getUserStatusJson(){
        int status = 1;
        ...
        try {
            ...
            jsonGenerator.writeStringField("user_status", String.valueOf(status));
